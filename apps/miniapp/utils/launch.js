...
exports.resolveEventId = resolveEventId;
exports.resolveMiniProgramEnvVersion = resolveMiniProgramEnvVersion;
...
function resolveMiniProgramEnvVersion(value) {
    if (value === 'develop' || value === 'trial' || value === 'release')
        return value;
    return 'release';
}
